# Pathfinding - Part 5
# A* Search, Dijkstra, dan Greedy BFS
# KidsCanCode 2017 - Modified
import pygame as pg
from os import path
import heapq
vec = pg.math.Vector2
...
# Create walls based on the maze pattern from the image
walls = [
    # Row 0
...
algorithms = [a_star_search, dijkstra_search, greedy_bfs_search]
algorithm_names = ["A* Search", "Dijkstra Search", "Greedy BFS"]
...
while running:
    ...
    draw_text('Mouse: Left=Wall, Middle=Start, Right=Goal', 20, NAVY_BLUE, 10, 35)
